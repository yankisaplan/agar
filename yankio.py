...
pygame.display.set_caption("Yanki.io")
cell_list = list()
...
def draw_HUD():
    ...
    drawText("3. I",(screen_width-157,20+25*3))
    drawText("4. u",(screen_width-157,20+25*4))
    ...
    drawText("9. dog",(screen_width-157,20+25*9))
    if(blob.mass <= 500):
        drawText("10. G #4",(screen_width-157,20+25*10))
    else:
        drawText("10. User",(screen_width-157,20+25*10),(210,0,0))
